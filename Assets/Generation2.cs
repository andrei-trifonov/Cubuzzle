...
public class Generation2 : MonoBehaviour
{
    ...
    void Generate_next(GameObject Point)
    {
        go.Clear();
...
*/
       ...
       newlist.Add(GameObject.Find ("x" + finalx + "_y" + finaly + "_z" + finalz));
       rand =  Random.Range(0, randlist.Count-1);

       int justx = randlist[rand].name[1] - 48;
       int justy = randlist[rand].name[4] - 48;
       int justz = randlist[rand].name[7] - 48;
       if  (!(finalx == justx && finaly == justy  || finalx == justx && finalz == justz || finaly == justy &&   finalz == justz)){
